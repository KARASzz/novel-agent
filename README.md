...
- 默认运行链路只依赖所选的 OpenAI Chat Completions 兼容模型、本地知识库以及可选的搜索引擎，**不再强绑定 DashScope 或红果短剧相关功能**。
...
- **正式源模板**：根目录 `webnovel_outline_template_v1.md` 和 `webnovel_setting_bible_template_v1.md`。
...
├── pre_hub/              # 前置决策立项中台
├── webnovel_*_template_v1.md # 小说大纲中台模板
